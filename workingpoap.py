#!/bin/env python
#md5sum="c9ae39c710740d1847dcf49182b1a057"
"""
...
options = {
   ...
   "mode": "serial_number",
   "target_system_image": "nxos.7.0.3.I4.7.bin",
   #"vrf": "management"
}
...
def set_defaults_and_validate_options():
    ...
    set_default("transfer_protocol", "tftp")
    # Directory where the config resides
    set_default("config_path", "/") #This needs to be / because the tftp server goes straight to #the tftpboot directory 
    ...
    # Personality
    set_default("personality_path", "/tftpboot")
...
def do_copy(source="", dest="", login_timeout=20, dest_tmp="", compact=False):
    """
